...
},{"./main.coffee":2}],3:[function(require,module,exports){
...
(function() {
  ...
  time = function() {
    ...
    now = new Date();
    return dateformat(now, 'mmmm dS, h:MM:ss');
  };
  ...
  exports.update = function(data) {
    var children, last, post_html, the_time;

    if (q("#id" + data.stamp) != null) {
      return q("#id" + data.stamp).querySelector('.text').innerText = data.text;
    } else {
      the_time = time();
...
},{"lilyturf":3,"dateformat":5}],5:[function(require,module,exports){
/*
 * Date Format 1.2.3
...
},{"./dom.coffee":4,"./ws.coffee":6}],6:[function(require,module,exports){
(function() {
  var io, ws;
...
},{"socket.io-client":7}],7:[function(require,module,exports){
